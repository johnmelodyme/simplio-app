...
class Gaps {
  ...
  static Gap gap6 = const Gap(Dimensions.padding6);
  ...
  static Gap gap14 = const Gap(Dimensions.padding14);
...
class Constants {
  ...
  static const updateBalanceThresholdDuration = Duration(seconds: 120);
}
