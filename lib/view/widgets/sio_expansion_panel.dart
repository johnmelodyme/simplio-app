...
class ExpansionPanel {
  ...
  ExpansionPanel({
    ...
    this.hasIcon = true,
    this.hasVerticalExpandedGap = true,
  ...
  /// Whether the panel has a icon.
  ///
  /// Defaults to true.
  final bool hasIcon;

  /// Whether the panel has a vertical gap when is expanded.
  ///
  /// Defaults to false.
  final bool hasVerticalExpandedGap;
...
class ExpansionPanelRadio extends ExpansionPanel {
  ...
  ExpansionPanelRadio({
    ...
    bool hasIcon = true,
    bool hasVerticalExpandedGap = true,
    ...
    Color? backgroundColor,
          ...
          hasIcon: hasIcon,
          hasVerticalExpandedGap: hasVerticalExpandedGap,
        );
...
class _ExpansionPanelListState extends State<ExpansionPanelList> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      if (widget.children[index].hasVerticalExpandedGap &&
