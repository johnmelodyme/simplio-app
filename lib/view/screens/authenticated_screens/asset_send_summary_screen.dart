...
class AssetSendSummaryScreen extends StatelessWidget {
    ...
    return Scaffold(
      body: BackGradient4(
        child: DragButton(
          ...
          label: context.locale.asset_send_summary_screen_submit,
          onDrag: () async {
                  ...
                  SliverPersistentHeader(
                    ...
                    delegate: FixedHeightItemDelegate(
                      ...
                      child: ColorizedAppBar(
                        title: context.locale.asset_send_summary_screen_title,
                      ),
                    ),
                  ),
                  SliverList(
                    delegate: SliverChildListDelegate(
                      [
                        ...
                        DetailRow.value(
                          ...
                          title: 'Recipient',
                          primaryValue:
                              'flsoidflk jsldkfj lksjfdkl jsdklfj lksdjfkls',
                        ),
                        Gaps.gap6,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  GradientButton(
                                    ...
                                    onTap: () {
                                      // TODO - showModalBottomSheet with a custom dialog that hanldes the fee priorities.
                                    },
                                  ),
                                  // Container(
                                  //   child: Text('Urgent'),
